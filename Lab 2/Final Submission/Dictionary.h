...
// IMPORTANT: DO NOT compute the polynomial value at one go, it will overflow the integer limit.
//You need to compute 'k' in various stages, starting from the inner-most bracket (see slides), and in each step take mod 1.
...
public:
    ...
    // -2 indicates empty
    // -1 indicates tombstone
    //  0 indicates occupied
};
...
class Dictionary {
 ...
 public:
  ...
  void show(); //Function added for display and better visualisation
};
